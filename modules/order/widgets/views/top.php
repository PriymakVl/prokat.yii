...
<!-- data menu -->
<div class="top-menu">
     <a href="<?=Url::to(['/order', 'order_id' => $order_id])?>" <? if ($action == 'index') echo 'class="top-menu-active-link"'; ?>>Информация</a>
     ...
     <a href="<?=Url::to(['/order/acts', 'order_id' => $order_id])?>" <? if ($action == 'acts') echo 'class="top-menu-active-link"'; ?>>Акты (<?=$count_acts?>)</a>
