...
<div class="top-menu top-menu-margin">
    ...
    <select id="order-period">
        ...
        <option value="4" <? if ($params['period'] == Order::PERIOD_CURRENT) echo 'selected'; ?>>Текущий</option>
    ...
    <select id="order-type">
        ...
        <option value="<?=Order::TYPE_INTERCHANGE?>" <? if ($params['type'] == Order::TYPE_INTERCHANGE) echo 'selected'; ?>>Смен. оборудование</option>
    </select>
</div>
