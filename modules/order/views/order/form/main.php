...
$this->registerJsFile('/js/order/order_form/form_set_customer_issuer.js');
...
<div id="order-form-main">
    <div class="top-box">
        ...
        <?php 
            ...
            Order::TYPE_CAPITAL_REPAIR => 'Кап. ремонт (6)',  Order::TYPE_ENHANCEMENT => 'Улучшение (1)', Order::TYPE_INTERCHANGE => 'Сменное оборудование (3)'];
